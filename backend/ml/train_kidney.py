...
KIDNEY_CSV = os.path.join(DATASETS_DIR, "kidney_disease.csv")
...
def train_kidney_model(data_path: str):
    ...
    # Save pipeline
    out_path = os.path.join(MODELS_DIR, "kidney_pipeline.pkl")
    joblib.dump(pipeline, out_path)
    print(f"\nSaved kidney pipeline to {out_path}")
